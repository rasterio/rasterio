...
exclude_patterns = ["_build", ".venv", ".pixi"]
...
latex_documents = [
    (master_doc, "rasterio.tex", "rasterio Documentation", "Sean Gillies", "manual"),
]
...
man_pages = [(master_doc, "rasterio", "rasterio Documentation", [author], 1)]
