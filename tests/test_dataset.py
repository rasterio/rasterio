...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            Affine.scale(1, -1),
            BoundingBox(0.0, -2.0, 2.0, 0.0),
            id="North-up transform",
        ),
        pytest.param(
            2,
            2,
            Affine.translation(2, 2) * Affine.scale(1, -1),
            BoundingBox(2.0, 0.0, 4.0, 2.0),
        ...
        pytest.param(
            ...
            BoundingBox(0.0, -math.sqrt(2), 2 * math.sqrt(2), math.sqrt(2)),
        ...
        pytest.param(
            ...
            2,
            Affine.scale(1, -1),
            BoundingBox(0, -2.0, 6.0, 0.0),
            id="Differing width and height",
        ),
    ],
)
def test_bounds(
    width, height, transform, expected_bounds, image_file_with_custom_size_and_transform
):
