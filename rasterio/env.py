        ...
        **options : optional
        ...
        if session:
            ...
            if not isinstance(session, Session):
                # Previously we presumed all these sessions were AWS
                # sessions, and so we have a special case to preserve.
                session = Session.from_foreign_session(session, cls=session_class)
